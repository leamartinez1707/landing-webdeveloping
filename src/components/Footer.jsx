  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0 overflow-hidden pointer-events-none opacity-10">
        <div className="absolute bottom-0 left-1/4 w-96 h-96 rounded-md blur-3xl"
      ...
      <div className="max-w-6xl mx-auto px-6 relative z-10">
        ...
        <motion.a
          ...
          className="inline-flex items-center gap-3 px-8 py-3 rounded-md font-semibold transition-all shadow-lg text-base group"
          style={{
        ...
        <div className="border-t border-gray-700 mt-8 pt-8">
          <p style={{ color: '#888888' }} className="text-sm">
            © {new Date().getFullYear()} Martínez Studio. Sistemas profesionales para negocios reales.
          </p>
        </div>
      </div>
    </motion.footer>
